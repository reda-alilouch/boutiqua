            ...
            if ($stmt->fetch()) {
                ...
                if ($update_password) {
                    ...
                    if ($dbUser && $dbUser['password'] === $current_password) {
                        ...
                        $stmt = $pdo->prepare('UPDATE user2 SET nom = ?, prenom = ?, email = ?, password = ?, avatar = ? WHERE id = ?');
                        $stmt->execute([$nom, $prenom, $email, $new_password, $avatarPath, $user['id']]);
                    } else {
                    ...
                    $stmt = $pdo->prepare('UPDATE user2 SET nom = ?, prenom = ?, email = ?, avatar = ? WHERE id = ?');
...
<head>
    ...
    <title>Mon Profil - HexaShop</title>
                    ...
                    <div class="bg-white rounded-lg shadow overflow-hidden">
                        <div class="p-6 text-center">
                            <div class="relative inline-block">
                                <img src="<?php echo !empty($user['avatar']) ? htmlspecialchars($user['avatar']) : 'https://ui-avatars.com/api/?name=' . urlencode($user['prenom'] . '+' . $user['nom']) . '&size=200'; ?>" 
                                     alt="Photo de profil" 
                        ...
                        <nav class="border-t border-gray-200">
                            ...
                            <a href="orders.php" class="block px-6 py-4 text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium">
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="wishlist.php" class="block px-6 py-4 text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium">
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="addresses.php" class="block px-6 py-4 text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium">
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="logout.php" class="block px-6 py-4 text-red-600 hover:bg-gray-50 font-medium">
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
